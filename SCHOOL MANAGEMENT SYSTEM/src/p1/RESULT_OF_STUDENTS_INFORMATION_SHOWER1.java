...
public class RESULT_OF_STUDENTS_INFORMATION_SHOWER1 extends JFrame
{
    static final String DATABASE_URL="jdbc:oracle:thin:@localhost:1521:XE";
    static final String USERNAME="shihab";
    static final String PASSWORD="123";
    static final String JDBC_DRIVER = "oracle.jdbc.OracleDriver"; 
    static final String  DEFAULT_QUERY="select * from RESULT ";
 
    private Resultsettablemodel tablemodel;
   private JTextArea queryarea;
   
   public RESULT_OF_STUDENTS_INFORMATION_SHOWER1() throws ClassNotFoundException
...
{
        new RESULT_OF_STUDENTS_INFORMATION_SHOWER1();
}
