...
public class STAFF_PANEL_PERSONAL_INFORMATION_SHOWER extends JFrame
{
    static final String DATABASE_URL="jdbc:oracle:thin:@localhost:1521:XE";
    static final String USERNAME="shihab";
    static final String PASSWORD="123";
    static final String JDBC_DRIVER = "oracle.jdbc.OracleDriver"; 
    static final String  DEFAULT_QUERY="select NAME,	POST	,	STAFF_SALARY from STAFF where STAFF_ID = -1 ";
 
    private Resultsettablemodel tablemodel;
   private JTextArea queryarea;
   
   public STAFF_PANEL_PERSONAL_INFORMATION_SHOWER() throws ClassNotFoundException
...
{
        new STAFF_PANEL_PERSONAL_INFORMATION_SHOWER();
}
