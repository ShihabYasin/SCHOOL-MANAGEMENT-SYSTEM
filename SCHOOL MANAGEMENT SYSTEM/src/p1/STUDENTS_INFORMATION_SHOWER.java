...
public class STUDENTS_INFORMATION_SHOWER extends JFrame
{
   ...
   public STUDENTS_INFORMATION_SHOWER() throws ClassNotFoundException
...
{
        new STUDENTS_INFORMATION_SHOWER();
}
